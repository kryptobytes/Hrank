...
uint256 hashGenesisBlock("0x7b5799ac15500b747a653544aeb83fc56dff5a6594a60c6edb6f4723ab24e606");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 30); // starting difficulty
...
const string strMessageMagic = "Hrank Signed Message:\n";
...
static const int64 nTargetTimespan = 36000; // Hrank: 1 days
static const int64 nTargetSpacing = 120; // Hrank: 120 second blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Hrank miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Hrank", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Postman - Coin generated through Kryptobyes 09:05:03-10/15/13";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1381839943; //mainnet epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce = 1552988 ;
        ...
        assert(block.hashMerkleRoot == uint256("0x83de4dd30efd3e8dd8dea0230d4c4e85ae1cefa11b391bddf3f9afc6a71e9e7e"));
